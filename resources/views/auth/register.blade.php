...
@section('content')
    <div class="w-full max-w-md bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 dark:bg-gray-800">
        <h2 class="text-2xl mb-6 text-center font-bold dark:text-white">Register</h2>
        ...
        <form method="POST" action="{{ route('register') }}">
            @csrf
            <div class="mb-4">
                <label for="name" class="block text-gray-700 text-sm font-bold dark:text-white mb-2">Name</label>
            ...
            <div class="mb-6">
                <label for="password_confirmation"
                    class="block dark:text-white text-gray-700 text-sm font-bold mb-2">Confirm
                    Password</label>
